...
class hmwk_5_10():
    ...
    def first_ans(self):
        with open('zy.txt', 'w+', encoding='utf-8') as f:
            f.write('1234567890')
            print(f.tell())
            print(f.seek(5))
            print(f.read(5))
    ...
    def second_ans(self):
        list2 = []
        with open('zy2.txt', 'w+', encoding='utf-8') as f:
        ...
        with open('zy3.txt', 'r') as fp:
            ...
            for i in temp:
                if 'url' not in i:
                    ...
                    dic3 = {}
                    dic3['url'] = i[i.find('url') + 4:i.find(',mobilephone')]
                    dic3['mobilephone'] = i[i.find(',mobilephone') + 12:i.find(',pwd')]
                    dic3['pwd'] = i[i.find(',pwd') + 4:i.find('\n')]
                    list3.append(dic3)
            print(list3)
        ...
        if search_me == '1':
            ...
            for i in book_all:
                if i[0] == book_No:
                    book_No_operated = book_all.index(i)
            print("\n********【系统】该书信息如下：\n********【系统】图书名称：《{0}》\n********【系统】图书位置：{1}".format(
                book_all[book_No_operated][1], book_all[book_No_operated][2]))
