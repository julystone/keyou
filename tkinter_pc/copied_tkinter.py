...
"""棋盘绘制"""
# 背景
canvas = tk.Canvas(root, bg="#CDAA7D", width=540, height=540)
...
# 数字坐标
for i in range(15):
    label = tk.Label(canvas, text=str(i + 1), fg="black", bg="#CDAA7D",
                     width=2, anchor=tk.E)
    label.place(x=2, y=35 * i + 28)
# 字母坐标
count = 0
for i in range(65, 81):
    label = tk.Label(canvas, text=chr(i), fg="black", bg="#CDAA7D")
