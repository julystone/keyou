...
for i in range(15):
    canvas.create_line(X_begin+X_Pianyi, (grid_scale * i + Y_begin)+Y_Pianyi, X_end+X_Pianyi, (grid_scale * i + Y_begin)+Y_Pianyi)
    canvas.create_line((grid_scale * i + X_begin)+X_Pianyi, Y_begin+Y_Pianyi, (grid_scale * i + X_begin)+X_Pianyi, Y_end+Y_Pianyi)
